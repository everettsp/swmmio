...
_HEADERS_YAML = os.path.join(_DEFS_PATH, 'section_headers_cms.yml')
_DEFAULT_VALS = os.path.join(_DEFS_PATH, 'default_values.yml')
...
with open(_DEFAULT_VALS, 'r') as f:
    DEFAULT_VALS = yaml.safe_load(f)
